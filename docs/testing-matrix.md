...
| Project APIs (list/create/update/delete) | ✅ | ✅ | ✅ | ✅ | `src/app/api/projects/route.test.ts`, `src/app/api/projects/[id]/route.ts` | Team | In progress |
...
| Admin-only form responses endpoint | ✅ | ✅ | ✅ | ✅ | `src/app/api/admin/form-responses/route.ts` | Team | TODO |
| About API authorization and write path | ✅ | ✅ | ◻️ | ✅ | `src/app/api/about/route.ts` | Team | TODO |
